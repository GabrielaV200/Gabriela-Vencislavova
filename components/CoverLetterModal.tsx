...
const CoverLetterModal: React.FC<CoverLetterModalProps> = ({ onClose, initialData }) => {
    ...
    const renderForm = () => (
        <>
            <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Generate Cover Letter</h2>
            </div>
            <div className="space-y-4">
                <div>
                    <label htmlFor="job-description-cl" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Job Description</label>
                    <textarea
                ...
                <div>
                    <label htmlFor="resume-cl" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Your Resume</label>
                    <textarea
                        id="resume-cl"
                        rows={8}
                        className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-800 focus:ring-indigo-500 focus:border-indigo-500"
         ...
         <>
            <div className="flex items-center justify-between gap-3 mb-4">
                <div className="flex items-center gap-3">
                    <EnvelopeIcon className="w-8 h-8 text-indigo-500" />
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Your Cover Letter</h2>
                </div>
